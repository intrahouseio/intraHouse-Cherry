 ...
 * Добавлена возможность управлять кешированием изображения у `устройства`
 * Добавлен параметр "Отображат точки" для виджета `График`
 * Добавлена возможность скрывать кнопку "Дискрета" для виджета `График`
 * Добавлен параметр "Отображат точки" для виджета `График` #121
 * Добавлена возможность скрывать кнопку "Дискрета" для виджета `График` #120
 * Добавлена возможность размещать виджет `Timeline` на `мнемосхемы` #118
 * Добавлены кнопки навигации для виджета `График`и `Timeline` #117
 * Добавлена возможность масштабировать кнопки виджетов #114
 * Добавлена возможность скрывать графики, нажатием по легенде  #111
 * Изменена логика размещения легенды #109
 * Изменена логика ввода/изменения пароля пользователя #106
 * Запоминание экрана при обновление страницы #101
