...
* В таблице Учетные записи добавлена команда "Завершить сессии учетной записи", при выполнении которой сбрасываются токены и закрываются сессии учетной записи на всех устройствах. Эти действия выполняются также при изменении пароля и при удалении Учетной записи
