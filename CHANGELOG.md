 ...
 * Доработан механизм сохранения данных в БД
   - [#94](https://github.com/intrahouseio/intraHouse-Cherry/issues/91) Различные стратегии: 
     наряду с сохранением при изменении при превышении дельты добавлена возможность сохранять выбранное (вычисленное) значение за период: среднее, min, max, min&max  
